                                        ...
                                        <div id="finding-cards-{{ $policy->id }}"
                                            ...
                                            @if (!$hasItems)
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-xs font-semibold text-gray-700 mb-1">Deskripsi</label>
                                                        <textarea name="findings[0][description]" rows="2" placeholder="Jelaskan temuan secara detail…"
